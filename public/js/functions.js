jQuery(document).ready(function ($) {
    ...
    //     $('.navbar-collapse').addClass('intro');
    //
    // })

    // $(document).on('click', '.navbar-toggle', function (){
    //     if( $('.navbar-collapse').hasClass('intro'))
    //     $('.navbar-collapse').removeClass('intro');
    //     else
    //         $('.navbar-collapse').addClass('intro');
    // })
    ...
    function azirspares_category_product($elem) {
        $elem.each(function () {
            ...
            _main.children('.cat-parent').each(function () {
                ...
                console.log("aaaaa");
                console.log($(this).children('.carets'));
    ...
    function eciga_clone_main_menu() {
    ...
    if ($('.slider-for , .flex-control-nav').length > 0) {
        $('.flex-viewport').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: false,
