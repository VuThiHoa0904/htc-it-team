            ...
            <div class="col-md-8 ">
                @foreach($contents as $content)
                    <div class="web-item col-md-12">
                        <div class="row">
                        <div class="col-md-4 web-img" style="background-image: url({{Voyager::image($content->image)}});">
{{--                            <img src="{{Voyager::image($website->image)}}" alt="" height="200px" width="200px">--}}
                        </div>
                        <div class="web-info col-md-8">
                            <a href="{{route('service.show_detail',[$content->service_id,$content->slug])}}"><h3 class="web_pg">{{ $content->title }}</h3></a>
                            <div class="post-date">
...
{{--                                {{$website->created_at}}--}}
                            ...
                            <p>{!!mb_strimwidth($content->meta_description, 0, 150, "...")!!}</p>
                        </div>
                        </div>
                    </div>
                @endforeach
