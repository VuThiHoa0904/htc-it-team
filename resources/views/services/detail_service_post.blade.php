...
{{--            <h1 class="padding-top-37">{{ $service->title }}</h1>--}}
            <div class="row">
                <div class="col-md-12">
                    <div class="new-item">
                    <div class="new-one" style="background-image: url({{Voyager::image($service->image)}})">
                    </div>
...
{{--                      </div>--}}
{{--                      <div class="form-group">--}}
{{--                        <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Điện thoại(*)">--}}
{{--                      </div>--}}
{{--                      <div class="form-group">--}}
